...
import { ActionsType, ColDir, ColType, GridColumn } from './../../../core/components/table/app-table';
...
import { FormProductComponent } from './../../../web-scraper/product/form-product/form-product.component';
...
export class ProductComponent implements OnInit, OnDestroy {
  ...
  models = new Array<AppDataProduct>();
  model = new AppDataProduct();
  ...
  grids = new Array<GridColumn>(
    ...
    new GridColumn("توضیحات", "descriptions", ColDir.ltr),
  );
  ...
  modal(model: AppDataProduct | null, parents: AppCategory[]) {
